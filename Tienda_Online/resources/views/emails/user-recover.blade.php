...
<p>Hola:  <strong>{{  $name }}<strong></p>
    <p>Este es un correo electrónico que le ayudara a reestablecer la contraseña de su cuenta.</p>
    <p>Para continuar haga clic en el siguiente botón e ingrese el siguiente código:<h2> {{$code}}</h2></p>
    <p><a href="{{ url('/reset') }}" style="display: inline-block; background-color: #2caaff; color: #fff; padding: 12px;
